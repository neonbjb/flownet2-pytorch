...
from utils.util import possible_checkpoint
...
class FlowNet2(nn.Module):
    ...
    def forward(self, inputs):
        ...
        # flownetc
        flownetc_flow2 = possible_checkpoint(self.checkpoint, self.flownetc, x)[0]
        flownetc_flow = possible_checkpoint(self.checkpoint, self.upsample1, flownetc_flow2*self.div_flow)
        ...
        # flownets1
        flownets1_flow2 = possible_checkpoint(self.checkpoint, self.flownets_1, concat1)[0]
        flownets1_flow = possible_checkpoint(self.checkpoint, self.upsample2, flownets1_flow2*self.div_flow)
        ...
        # flownets2
        flownets2_flow2 = possible_checkpoint(self.checkpoint, self.flownets_2, concat2)[0]
        flownets2_flow = possible_checkpoint(self.checkpoint, self.upsample4, flownets2_flow2 * self.div_flow)
        ...
        # flownetsd
        flownetsd_flow2 = possible_checkpoint(self.checkpoint, self.flownets_d, x)[0]
        flownetsd_flow = possible_checkpoint(self.checkpoint, self.upsample3, flownetsd_flow2 / self.div_flow)
